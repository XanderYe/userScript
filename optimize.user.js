...
jQ(function($){
    ...
    if (website("zhuanlan.zhihu")) {
        ...
        // CSDN 隐藏登录弹窗 去除登录复制
        newNode = document.createTextNode(".passport-container,.passport-login-container,#passportbox,.passport-login-mark,.leftPop,.opt-box,.signin {display: none !important} .comment-list-box {max-height: none !important} .htmledit_views code ol li{height: 26px !important} code,pre {user-select: text!important}");
