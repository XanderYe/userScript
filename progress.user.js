...
(function () {
  ...
  if (host.indexOf("iqiyi") > -1) {
    ...
    barNode = document.createTextNode(".txp_autohide .txp_bottom {opacity: 1 !important; bottom: -50px !important} .plugin_ctrl_txp_bottom.txp_none {display: block !important; bottom: -90px !important} .plugin_ctrl_fake_fullscreen #ssi-header {display: none}");
